...
public class UserController {
     ...
     * **/
    public int   createUser (String id, String  name, String lastname ,String username, String password, String email, String perfil,Convocatoria conv ){
        //System.out.println("en user controller : entramos a create user:"+callName);
        //Convocatoria convocatoria = convocatoriaController.readConv(callName);
        Usuario U = new Usuario(name,lastname,username,password,email,perfil,id,conv);        
