...
public class DAOUser {
        ...
        try{
            ...
            System.out.println("antes del if prof: "+prof);
             if(!(prof.equals("Administrador"))){
                ...
                System.out.println("despues de la consulta dao us");
	...
	sql_save1="UPDATE usuario SET name='"+us.getName()+"' WHERE cedula='" + us.getCedula() + "'";
        ...
        switch(us.getProfile()){
            case "1":   sql_save6="UPDATE usuario SET id_perfil='1' WHERE cedula='" + us.getCedula() + "'";
                                break;
            case "2": sql_save6="UPDATE usuario SET id_perfil='2' WHERE cedula='" + us.getCedula() + "'";
                                break;
            case "3":   sql_save6="UPDATE usuario SET id_perfil='3' WHERE cedula='" + us.getCedula() + "'";
                                    break;
            default: return -3;
